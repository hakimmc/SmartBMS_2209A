...
\label{_tcp_server_8h}\index{include/TcpServer.h@{include/TcpServer.h}}
...
\#define \textbf{ SERVER\+\_\+\+PORT}~5166
...
\index{TcpServer.h@{TcpServer.h}!SERVER\_PORT@{SERVER\_PORT}}
...
\index{TcpServer.h@{TcpServer.h}!TCP\_TAG@{TCP\_TAG}}
...
\index{TcpServer.h@{TcpServer.h}!WIFI\_CONNECTED\_BIT@{WIFI\_CONNECTED\_BIT}}
...
Event bit indicating a successful Wi-\/\+Fi connection. \index{TcpServer.h@{TcpServer.h}!WIFI\_FAIL\_BIT@{WIFI\_FAIL\_BIT}}
...
\index{TcpServer.h@{TcpServer.h}!Create\_Server@{Create\_Server}}
...
\hline
\end{DoxyParams}
\index{TcpServer.h@{TcpServer.h}!Handle\_Client@{Handle\_Client}}
...
\hline
\end{DoxyParams}
\index{TcpServer.h@{TcpServer.h}!receive\_data@{receive\_data}}
...
\end{DoxyReturn}
\index{TcpServer.h@{TcpServer.h}!Tcp\_Init@{Tcp\_Init}}
